...
Java_com_airremote_android_IRDecoder_getVersion(JNIEnv *env, jobject obj)
{
  return env->NewStringUTF( version_cstr );
}

JNIEXPORT jboolean JNICALL
Java_com_airremote_android_IRDecoder_decode(JNIEnv *env, jobject obj,
			   jintArray jctx,
			   jintArray jbursts,
			   jint repeatPart,
			   jint freq )
...
JNIEXPORT jboolean JNICALL
Java_com_airremote_android_IRDecoder_decode2(JNIEnv *env, jobject obj,
			   jintArray jctx,
			   jintArray jbursts,
			   jint repeatPart,
			   jint extraPart,
